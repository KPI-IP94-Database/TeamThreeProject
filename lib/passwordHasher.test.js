...
describe('hashPassword valid arguments', () => {
  ...
  test('different results for same passwords but no passed salt', () => {
    ...
    expect(hashOne)
      .not.toStrictEqual(hashTwo);

    expect(hashOne.passwordHash)
      .not.toEqual(hashTwo.passwordHash);
  });
...
describe('hashPassword strange, but possible arguments', () => {
  ...
  test('blank salt string == no salt is passed', () => {
    const password = 'password';
    const salt = '';
  ...
  test('undefined salt == no salt is passed', () => {
    const password = 'password';
  ...
  test('null salt == no salt is passed', () => {
    const password = 'password';
    const salt = null;
