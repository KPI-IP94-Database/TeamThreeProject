 ...
 *
 */
Database.prototype.createTable = async function(tableModel) {
 ...
 */
Database.prototype.insert = async function(table, values) {
 ...
 * ```
 */
Database.prototype.ifExists = async function(table, field, value, callback) {
 ...
 *
 */
Database.prototype.ifAssExists = async function(table, assField, assValue,
  field, value, callback) {
 ...
 */
Database.prototype.removeRow = async function(table, field, value) {
...
Database.prototype.update = async function(table, field, value, newValue) {
...
Database.prototype.getObject = async function(table, field, value, callback) {
